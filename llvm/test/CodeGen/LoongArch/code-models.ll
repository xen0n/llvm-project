...
; LARGE:       # %bb.0: # %entry
; LARGE-NEXT:    addi.d $a1, $zero, %got_pc_lo12(callee_tail)
; LARGE-NEXT:    lu32i.d $a1, %got64_pc_lo20(callee_tail)
; LARGE-NEXT:    lu52i.d $a1, $a1, %got64_pc_hi12(callee_tail)
; LARGE-NEXT:    pcalau12i $a2, %got_pc_hi20(callee_tail)
; LARGE-NEXT:    ldx.d $a1, $a1, $a2
; LARGE-NEXT:    jr $a1
entry:
