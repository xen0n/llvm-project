...
; LA64LARGEPIC-NEXT:    addi.d $a0, $zero, %got_pc_lo12(unspecified)
; LA64LARGEPIC-NEXT:    lu32i.d $a0, %got64_pc_lo20(unspecified)
; LA64LARGEPIC-NEXT:    lu52i.d $a0, $a0, %got64_pc_hi12(unspecified)
; LA64LARGEPIC-NEXT:    pcalau12i $a1, %gd_pc_hi20(unspecified)
; LA64LARGEPIC-NEXT:    add.d $a0, $a0, $a1
...
; LA64LARGENOPIC-NEXT:    addi.d $a0, $zero, %ie_pc_lo12(unspecified)
; LA64LARGENOPIC-NEXT:    lu32i.d $a0, %ie64_pc_lo20(unspecified)
; LA64LARGENOPIC-NEXT:    lu52i.d $a0, $a0, %ie64_pc_hi12(unspecified)
; LA64LARGENOPIC-NEXT:    pcalau12i $a1, %ie_pc_hi20(unspecified)
; LA64LARGENOPIC-NEXT:    add.d $a0, $a0, $a1
...
; LA64LARGEPIC-NEXT:    addi.d $sp, $sp, -16
; LA64LARGEPIC-NEXT:    st.d $ra, $sp, 8 # 8-byte Folded Spill
; LA64LARGEPIC-NEXT:    addi.d $a0, $zero, %got_pc_lo12(ld)
; LA64LARGEPIC-NEXT:    lu32i.d $a0, %got64_pc_lo20(ld)
; LA64LARGEPIC-NEXT:    lu52i.d $a0, $a0, %got64_pc_hi12(ld)
; LA64LARGEPIC-NEXT:    pcalau12i $a1, %ld_pc_hi20(ld)
; LA64LARGEPIC-NEXT:    add.d $a0, $a0, $a1
; LA64LARGEPIC-NEXT:    addi.d $ra, $zero, %pc_lo12(__tls_get_addr)
; LA64LARGEPIC-NEXT:    lu32i.d $ra, %pc64_lo20(__tls_get_addr)
; LA64LARGEPIC-NEXT:    lu52i.d $ra, $ra, %pc64_hi12(__tls_get_addr)
...
; LA64LARGENOPIC:       # %bb.0: # %entry
; LA64LARGENOPIC-NEXT:    addi.d $a0, $zero, %ie_pc_lo12(ld)
; LA64LARGENOPIC-NEXT:    lu32i.d $a0, %ie64_pc_lo20(ld)
; LA64LARGENOPIC-NEXT:    lu52i.d $a0, $a0, %ie64_pc_hi12(ld)
; LA64LARGENOPIC-NEXT:    pcalau12i $a1, %ie_pc_hi20(ld)
; LA64LARGENOPIC-NEXT:    add.d $a0, $a0, $a1
; LA64LARGENOPIC-NEXT:    add.d $a0, $a0, $tp
; LA64LARGENOPIC-NEXT:    ret
entry:
...
; LA64LARGEPIC:       # %bb.0: # %entry
; LA64LARGEPIC-NEXT:    addi.d $a0, $zero, %ie_pc_lo12(ie)
; LA64LARGEPIC-NEXT:    lu32i.d $a0, %ie64_pc_lo20(ie)
; LA64LARGEPIC-NEXT:    lu52i.d $a0, $a0, %ie64_pc_hi12(ie)
; LA64LARGEPIC-NEXT:    pcalau12i $a1, %ie_pc_hi20(ie)
; LA64LARGEPIC-NEXT:    add.d $a0, $a0, $a1
...
; LA64LARGENOPIC:       # %bb.0: # %entry
; LA64LARGENOPIC-NEXT:    addi.d $a0, $zero, %ie_pc_lo12(ie)
; LA64LARGENOPIC-NEXT:    lu32i.d $a0, %ie64_pc_lo20(ie)
; LA64LARGENOPIC-NEXT:    lu52i.d $a0, $a0, %ie64_pc_hi12(ie)
; LA64LARGENOPIC-NEXT:    pcalau12i $a1, %ie_pc_hi20(ie)
; LA64LARGENOPIC-NEXT:    add.d $a0, $a0, $a1
; LA64LARGENOPIC-NEXT:    add.d $a0, $a0, $tp
; LA64LARGENOPIC-NEXT:    ret
entry:
