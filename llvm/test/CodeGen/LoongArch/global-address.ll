...
; LA64LARGENOPIC:       # %bb.0:
; LA64LARGENOPIC-NEXT:    addi.d $a0, $zero, %got_pc_lo12(G)
; LA64LARGENOPIC-NEXT:    lu32i.d $a0, %got64_pc_lo20(G)
; LA64LARGENOPIC-NEXT:    lu52i.d $a0, $a0, %got64_pc_hi12(G)
; LA64LARGENOPIC-NEXT:    pcalau12i $a1, %got_pc_hi20(G)
; LA64LARGENOPIC-NEXT:    ldx.d $a0, $a0, $a1
; LA64LARGENOPIC-NEXT:    ld.w $a0, $a0, 0
; LA64LARGENOPIC-NEXT:    addi.d $a0, $zero, %pc_lo12(g)
; LA64LARGENOPIC-NEXT:    lu32i.d $a0, %pc64_lo20(g)
; LA64LARGENOPIC-NEXT:    lu52i.d $a0, $a0, %pc64_hi12(g)
; LA64LARGENOPIC-NEXT:    pcalau12i $a1, %pc_hi20(g)
...
; LA64LARGEPIC:       # %bb.0:
; LA64LARGEPIC-NEXT:    addi.d $a0, $zero, %got_pc_lo12(G)
; LA64LARGEPIC-NEXT:    lu32i.d $a0, %got64_pc_lo20(G)
; LA64LARGEPIC-NEXT:    lu52i.d $a0, $a0, %got64_pc_hi12(G)
; LA64LARGEPIC-NEXT:    pcalau12i $a1, %got_pc_hi20(G)
; LA64LARGEPIC-NEXT:    ldx.d $a0, $a0, $a1
; LA64LARGEPIC-NEXT:    ld.w $a0, $a0, 0
; LA64LARGEPIC-NEXT:    addi.d $a0, $zero, %pc_lo12(.Lg$local)
; LA64LARGEPIC-NEXT:    lu32i.d $a0, %pc64_lo20(.Lg$local)
; LA64LARGEPIC-NEXT:    lu52i.d $a0, $a0, %pc64_hi12(.Lg$local)
; LA64LARGEPIC-NEXT:    pcalau12i $a1, %pc_hi20(.Lg$local)
